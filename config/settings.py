...
MAX_COMPETITORS_PER_PLATFORM = _env_int("MAX_COMPETITORS_PER_PLATFORM", _env_int("MAX_COMPETITORS_YOUTUBE", 20))
MAX_COMPETITORS_YOUTUBE = MAX_COMPETITORS_PER_PLATFORM
...
ENABLE_YOUTUBE_SUPPLEMENTAL_TOPIC_VIDEO_COLLECTION = _env_bool("ENABLE_YOUTUBE_SUPPLEMENTAL_TOPIC_VIDEO_COLLECTION", False)
